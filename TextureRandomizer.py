...
def main():
    ...
    # Creates the new ressource pack directory and folder and paste the pack.mcmeta in the new ressource pack
    ...
    # Creates the new ressource pack by associating the blocks to their new textures
